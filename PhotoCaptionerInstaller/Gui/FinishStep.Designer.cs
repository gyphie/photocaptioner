namespace Gui
{
	partial class FinishStep
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbRestartNow = new System.Windows.Forms.CheckBox();
			...
			// cbRestartNow
			// 
			resources.ApplyResources(this.cbRestartNow, "cbRestartNow");
			this.cbRestartNow.Name = "cbRestartNow";
			this.cbRestartNow.UseVisualStyleBackColor = true;
			// 
			// FinishStep
			// 
			resources.ApplyResources(this, "$this");
			this.Controls.Add(this.cbRestartNow);
			...
			this.Controls.SetChildIndex(this.cbRestartNow, 0);
		...
		private System.Windows.Forms.CheckBox cbRestartNow;
